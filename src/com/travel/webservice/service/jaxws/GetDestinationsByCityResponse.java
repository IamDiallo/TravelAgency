...
public class GetDestinationsByCityResponse {
    ...
    private java.util.List<com.travel.webservice.model.Destinations> result;

    public java.util.List<com.travel.webservice.model.Destinations> getResult() {
        return this.result;
    }

    public void setResult(java.util.List<com.travel.webservice.model.Destinations> newResult)  {
